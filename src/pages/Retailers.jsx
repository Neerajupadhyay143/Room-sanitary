        ...
        <div className="bg-white rounded-lg shadow-lg p-6 sm:p-8 mb-8 sm:mb-12">
          ...
          <form onSubmit={handleSearch} className="max-w-2xl mx-auto">
            <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
              ...
              <button
                type="submit"
                className="bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 px-6 sm:px-8 rounded-lg transition-colors text-sm sm:text-base"
              >
                Search
              </button>
            </div>
            ...
            {retailers.map((retailer) => (
              <div key={retailer.id} className="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow">
                <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start mb-4">
                  ...
                  {retailer.distance && (
                    <span className="bg-blue-100 text-blue-800 text-sm px-3 py-1 rounded-full self-start">
                ...
                <div className="space-y-3">
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      <p className="text-sm sm:text-base text-gray-700">{retailer.address}</p>
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <p className="text-sm sm:text-base text-gray-700">{retailer.hours}</p>
                  </div>
                </div>

                <div className="mt-6 flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-4">
                  <button className="flex-1 bg-blue-600 hover:bg-blue-700 text-white font-medium py-2 px-4 rounded-lg transition-colors text-sm sm:text-base">
                    Get Directions
                  </button>
                  <button className="flex-1 border border-gray-300 hover:bg-gray-50 text-gray-700 font-medium py-2 px-4 rounded-lg transition-colors text-sm sm:text-base">
                    Call Store
                  </button>
                </div>
              </div>
            ...
            <div className="bg-white rounded-lg shadow-md p-6">
              ...
              <div className="bg-gray-200 h-64 sm:h-96 rounded-lg flex items-center justify-center">
                <p className="text-gray-600 text-center text-sm sm:text-base">
                  ...
                  <span className="text-xs sm:text-sm">Showing retailer locations</span>
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="mt-12 sm:mt-16 bg-blue-50 rounded-lg p-6 sm:p-8">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            <div className="text-center">
              ...
              <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-2">Prime Locations</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-2">Dedicated Support</h3>
              <p className="text-sm sm:text-base text-gray-600">
          ...
          <div className="text-center mt-6 sm:mt-8">
            <button className="bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 px-6 sm:px-8 rounded-lg transition-colors text-sm sm:text-base">
